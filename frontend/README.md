...
# Learn the React-App folder structure:
...
# More
For detailed basic code of creating a google map please refer to the doc: *./create\_basic\_google\_map\_reactjs.md*
